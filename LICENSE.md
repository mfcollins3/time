...
Naked Naked Time Source-Available Temporary License (v0.0.1; April 11, 2026)

:exclamation: __IMPORTANT:__ This is a [source-available license](https://en.wikipedia.org/wiki/Source-available_software) and is not an [open source license](https://en.wikipedia.org/wiki/Open-source_software). Please read the license agreement carefully before proceeding to use the software. The rights granted below are limited, temporary, and subject to change upon a future commercial release of the software.

### 1. Definitions

- "Software" means the Naked Time product, including its source code, build scripts, configuration, and associated assets contained in this repository.
...
- Use the Software, trademarks, logos, or trade dress of the Naked Time product or the copyright holder in any way that suggests endorsement or affiliation without prior written permission;
...
### 2. Will the Naked Time Product Remain Source-Available After Commercialization?

Yes. If in the future, I commercialize the Naked Time product and begin charging a fee to license the product, the source code for Naked Time will remain source-available and you will continue to be able to access the latest source code and use your own derivative versions if you have created them.

### 3. Why are you Licensing Naked Time like this?
